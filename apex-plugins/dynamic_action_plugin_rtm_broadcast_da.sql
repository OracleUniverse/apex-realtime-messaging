...
'',
unistr('    -- \D83D\DD34 IMPORTANT: expose all the attributes to JS'),
'    -- Map these according to how you defined them in the plug-in:',
'    -- 01 = API Key',
'    -- 02 = Base URL',
'    -- 03 = Channel',
'    -- 04 = Event Name',
'    -- 05 = Payload Item (APEX item name, e.g. P10_MESSAGE)',
'    -- 06 = On Error',
...
'',
'    RETURN l_result;',
'END rtm_da_broadcast_render;',
'',
'',
'',
'FUNCTION rtm_da_broadcast_ajax (',
'    p_dynamic_action IN apex_plugin.t_dynamic_action,',
'    p_plugin         IN apex_plugin.t_plugin',
...
'    l_payload_json CLOB;',
'BEGIN',
'    l_api_key    := p_dynamic_action.attribute_01;',
'    l_base_url   := apex_plugin_util.replace_substitutions(p_dynamic_action.attribute_02);',
'    l_channel    := apex_plugin_util.replace_substitutions(p_dynamic_action.attribute_03);',
'    l_event_name := apex_plugin_util.replace_substitutions(p_dynamic_action.attribute_04);',
'    l_on_error   := NVL(p_dynamic_action.attribute_06, ''RAISE'');',
'',
unistr('    -- \D83D\DD34 Take payload exactly as sent from JS'),
'    l_payload_json := apex_application.g_x01;',
'',
'    IF l_payload_json IS NULL THEN',
'        l_payload_json := ''{}'';',
'    END IF;',
'',
'    BEGIN',
...
'        apex_json.write(''channel'',   l_channel);',
'        apex_json.write(''eventName'', l_event_name);',
'        apex_json.write(''payload'',   l_payload_json);',
...
'            CASE l_on_error',
'                WHEN ''LOG'' THEN',
'                    apex_debug.error(''RTM DA Broadcast error: %s'', SQLERRM);',
'                    apex_json.open_object;',
...
'                WHEN ''IGNORE'' THEN',
'                    apex_json.open_object;',
'                    apex_json.write(''status'', ''IGNORED'');',
'                    apex_json.close_object;',
'                ELSE',
'                    RAISE;',
'            END CASE;',
